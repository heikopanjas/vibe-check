...
Please confirm you've read and understood these instructions before we begin. Also remember to update the instructions as we go. Only update the AGENTS.md.
