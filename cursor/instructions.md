...
## Agent-Specific Variations for Cursor
...
## Detailed Initial Prompts for Cursor
...
As we work together, remember to update ONLY the AGENTS.md file as coding standards, conventions, or project decisions evolve. The .cursor/rules/main.mdc file is just a reference pointer and should rarely need changes unless the reference mechanism itself changes.
...
## Quick Copy-Paste Version for Cursor
