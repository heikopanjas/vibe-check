...
## Agent-Specific Variations for Claude
...
## Detailed Initial Prompts for Claude
...
As we work together, remember to update ONLY the AGENTS.md file as coding standards, conventions, or project decisions evolve. The CLAUDE.md file is just a reference pointer and should rarely need changes unless the reference mechanism itself changes.
...
## Quick Copy-Paste Version for Claude
